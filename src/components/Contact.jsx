...
const Contact = () => {
  ...
  const handleSubmit = (e)=>{
    e.preventDefault();
    setLoading(true);
    emailjs.send("service_kg4h9v8",
      "template_jtfdn8i",
      {from_name:form.name,
        to_name:"Aditya Krishna",
        from_email:form.email,
        to_email:'adityakrishna585@gmail.com',
 ...
 bg-black-100 p-8 rounded-2xl">
  ...
  <form className='mt-12 flex flex-col gap-8' onSubmit={handleSubmit} ref={formRef}>
    ...
    <label className='flex flex-col'>
      ...
      <input type="text" name='email' value={form.email} onChange={handleChange} placeholder='What is your email?' className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium' />
    </label>
    <label className='flex flex-col'>
      <span className='text-white
    ...
    outline-none wi-fit text-white
